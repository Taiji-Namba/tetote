    ...
    <div class="footer__inner">
      ...
      <div class="footer__menu-wrapper">
        <div class="footer__menus">
          <a href="<?php echo esc_url(home_url() . '/#'); ?>" class="footer__logo"><img class="footer__img logo__img logo__img--black" src="<?php echo esc_url(get_template_directory_uri() . '/assets/images/logo-black.svg'); ?>" alt="「TETOTE」のロゴ"></a>
