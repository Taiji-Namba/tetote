<section class="p-top-recruitment p-top-section">
  <div class="p-top-recruitment__inner">
    <div class="p-top-section__titles u-block-center">
      <h4 class="c-common-title p-top-section__title">採用情報</h4>
      <p class="p-top-section__background-title p-top-section__background-title--center">RECRUITMENT</p>
    </div>
